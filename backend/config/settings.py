...
ALLOWED_HOSTS = ['192.168.8.143', '127.0.0.1', '172.20.10.3', '172.29.80.1', 'localhost', '192.168.43.14', '10.101.58.132']
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://172.20.10.3:5173",  # если ты заходишь с другого устройства
]
